...
<head>
                    ...
                    <td style="width: 250px;">
                        ...
                        ?>
                            <form action="" method="post">
                                ...
                                <button type="submit" name="terima" class="btn btn-outline-success"> produk sudah diterima</button>
                            </form>
                        <?php
                        } elseif ($status == "produk telah diterima") {
                        ?>
    ...
    if (isset($_POST['terima'])) {
        ...
        include "koneksitoko.php";
        $sql = mysqli_query($conn, "update transaksi set status = 'produk telah diterima' WHERE id_transaksi ='$id_transaksi' ");
        if ($sql) {
            echo "<script>location.href='histori_pembelian_pelanggan.php'</script>";
        }
    }
    ?>
